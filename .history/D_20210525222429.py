...
class DataBase():
    ...
    def creat_table(self):
        create_table_query = '''CREATE TABLE wordtable(id int NOT NULL primary key AUTO_INCREMENT comment 'primary key',adjective varchar(10) comment '',noun varchar(10) comment '',place varchar(10) comment '',verb varchar(10) comment ''
